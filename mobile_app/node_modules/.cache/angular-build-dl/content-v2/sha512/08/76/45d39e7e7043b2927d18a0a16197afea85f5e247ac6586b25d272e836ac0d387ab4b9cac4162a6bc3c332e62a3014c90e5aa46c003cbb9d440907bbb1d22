...
const Slides = class {
    ...
    async initSwiper() {
        ...
        // init swiper core
        // @ts-ignore
        const { Swiper } = await __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./swiper.bundle-ccdaac54.js */ "./node_modules/@ionic/core/dist/esm/swiper.bundle-ccdaac54.js"));
