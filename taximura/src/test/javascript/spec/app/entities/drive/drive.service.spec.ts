...
describe('Service Tests', () => {
  describe('Drive Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Drive(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Drive', () => {
        ...
        service.create(new Drive()).subscribe(resp => (expectedResult = resp.body));
