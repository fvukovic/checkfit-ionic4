          ...
          _this.storage.get("username").then(function (username) {
            if (username != null) {
              setInterval(function () {
                _this.locationService.getUserPosition().then(function (val) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = _context.t0 === "DRIVE_REQUEST" ? 3 : _context.t0 === "INFORM_DRIVE_CUSTOMER" ? 5 : _context.t0 === "INFORM_DRIVE_DRIVER" ? 7 : _context.t0 === "ACCEPT_DRIVE" ? 10 : _context.t0 === "ACCEPT_DRIVE_DRIVER" ? 12 : _context.t0 === "FINISH_DRIVE_CUSTOMER" ? 14 : _context.t0 === "SOS" ? 17 : _context.t0 === "DRIVER_INFO" ? 22 : 23;
                    break;
