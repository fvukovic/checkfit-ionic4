...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _ionic_native_sim_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/sim/ngx */ "./node_modules/@ionic-native/sim/ngx/index.js");
...
let SearchRidePage = class SearchRidePage {
    constructor(socketService, route, events, sim) {
        ...
        this.sim.getSimInfo().then((info) => console.log('Sim info: ', info), (err) => console.log('Unable to get sim info: ', err));
        this.sim.hasReadPermission().then((info) => console.log('Has permission: ', info));
...
SearchRidePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_socket_service__WEBPACK_IMPORTED_MODULE_2__["SocketService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Events"], _ionic_native_sim_ngx__WEBPACK_IMPORTED_MODULE_5__["Sim"]])
], SearchRidePage);
